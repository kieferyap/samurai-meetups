$(document).ready(function() {
	...
	// This is the GH-PAGES version, so I'm not putting any functionality for now.
	// I'm aware that I could just use a .json file to serve as the data source but
	// I'm kind of pressed for time at the moment, so. not now. :U
